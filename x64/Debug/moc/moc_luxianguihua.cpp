...
QT_MOC_LITERAL(1, 13, 3), // "sub"
QT_MOC_LITERAL(2, 17, 0), // ""
QT_MOC_LITERAL(3, 18, 14) // "upgrade_signal"

    },
    "luxianguihua\0sub\0\0upgrade_signal"
};
...
void luxianguihua::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        luxianguihua *_t = static_cast<luxianguihua *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->sub(); break;
        case 1: _t->upgrade_signal(); break;
        default: ;
        }
    } else if (_c == QMetaObject::IndexOfMethod) {
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            using _t = void (luxianguihua::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&luxianguihua::sub)) {
                *result = 0;
                return;
            }
        }
        {
            using _t = void (luxianguihua::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&luxianguihua::upgrade_signal)) {
                *result = 1;
                return;
            }
        }
...
// SIGNAL 0
void luxianguihua::sub()
{
    QMetaObject::activate(this, &staticMetaObject, 0, nullptr);
}

// SIGNAL 1
void luxianguihua::upgrade_signal()
{
